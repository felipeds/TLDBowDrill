...
SubShader { 
 ...
 //         d3d9: 57 avg math (40..75)
 //        d3d11: 42 avg math (29..55)
 // Stats for Fragment shader:
 //         d3d9: 162 avg math (158..166), 6 avg texture (6..7), 14 branch
...
// No shader variant for this keyword set. The closest match will be used instead.
 ...
 // Stats for Fragment shader:
 //         d3d9: 98 avg math (78..118), 3 avg texture (1..7)
 //        d3d11: 101 avg math (82..120), 3 avg texture (2..4), 2 avg branch (2..4)
 Pass {
  Name "FORWARD_DELTA"
...
-- Fragment shader for "d3d11":
// Stats: 91 math, 3 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0
Set 2D Texture "_LightTexture0" to slot 1
...
-- Fragment shader for "d3d11":
// Stats: 82 math, 2 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0
...
-- Fragment shader for "d3d11":
// Stats: 92 math, 4 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0
...
-- Fragment shader for "d3d11":
// Stats: 87 math, 3 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0
Set 2D Texture "_LightTexture0" to slot 1
Set 3D Texture "unity_ProbeVolumeSH" to slot 2
...
-- Fragment shader for "d3d11":
// Stats: 114 math, 4 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0
Set 2D Texture "_LightTexture0" to slot 1
Set 2D Texture "_LightTextureB0" to slot 2
Set 3D Texture "unity_ProbeVolumeSH" to slot 3
...
//
    ...
    ps_3_0
    def c22, -0.220916301, 0.220916301, 0.779083729, 1
    def c23, 1, 0, 0.25, 0.5
    def c24, 0.00100000005, 31.622776, 9.99999975e-006, 0.318309873
    def c25, 1.00000001e-007, 3.14159274, 9.99999975e-005, 0.00999999978
    dcl_texcoord v0.xy
    dcl_texcoord1_pp v1.xyz
    dcl_texcoord2_pp v2.w
    dcl_texcoord3_pp v3.w
    ...
    mul r0.w, r0.w, r2.y
    mul_pp r2.y, r0.w, c25.y
    mad r0.w, r0.w, -c25.y, c25.z
    rsq r2.y, r2.y
    rcp_pp r2.y, r2.y
    cmp_pp r0.w, r0.w, c25.w, r2.y
    mul_pp r0.w, r3.x, r0.w
    texld r4, v0, s1
...
-- Fragment shader for "d3d11":
// Stats: 120 math, 4 textures, 4 branches
Set 2D Texture "_MainTex" to slot 0
Set 2D Texture "_LightTexture0" to slot 1
Set 2D Texture "_LightTextureB0" to slot 2
Set 3D Texture "unity_ProbeVolumeSH" to slot 3
...
//
   ...
   2: mad r0.xyz, cb0[8].xyzx, r0.xyzx, l(-0.220916, -0.220916, -0.220916, 0.000000)
   3: mad r0.xyz, cb0[12].zzzz, r0.xyzx, l(0.220916, 0.220916, 0.220916, 0.000000)
   4: mad r0.w, -cb0[12].z, l(0.779084), l(0.779084)
   5: mul r1.xyz, r0.wwww, r1.xyzx
   6: dp3 r0.w, v5.xyzx, v5.xyzx
   7: rsq r0.w, r0.w
   8: mul r2.xyz, r0.wwww, v5.xyzx
...
-- Fragment shader for "d3d11":
// Stats: 93 math, 3 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0
Set 2D Texture "_ShadowMapTexture" to slot 1
Set 3D Texture "unity_ProbeVolumeSH" to slot 2
...
-- Fragment shader for "d3d11":
// Stats: 98 math, 4 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0
Set 2D Texture "_ShadowMapTexture" to slot 1
Set 2D Texture "_LightTexture0" to slot 2
Set 3D Texture "unity_ProbeVolumeSH" to slot 3
...
//
    ...
    ps_3_0
    def c14, -0.220916301, 0.220916301, 0.779083729, 0.970000029
    def c15, 1, 0, 0.00100000005, 31.622776
    def c16, -0.5, 9.99999975e-006, 0.5, 0.318309873
    def c17, 1.00000001e-007, 3.14159274, 9.99999975e-005, 0.00999999978
    dcl_texcoord v0.xy
    dcl_texcoord1_pp v1.xyz
    dcl_texcoord2_pp v2.w
    dcl_texcoord3_pp v3.w
    ...
    mul r0.w, r0.w, r2.x
    mul_pp r2.x, r0.w, c17.y
    mad r0.w, r0.w, -c17.y, c17.z
    rsq r2.x, r2.x
    rcp_pp r2.x, r2.x
    cmp_pp r0.w, r0.w, c17.w, r2.x
...
-- Fragment shader for "d3d11":
// Stats: 107 math, 3 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0
...
-- Fragment shader for "d3d11":
// Stats: 113 math, 3 textures, 4 branches
Set 2D Texture "_MainTex" to slot 0
Set CUBE Texture "_ShadowMapTexture" to slot 1
Set 2D Texture "_LightTexture0" to slot 2
Set 3D Texture "unity_ProbeVolumeSH" to slot 3
...
-- Fragment shader for "d3d11":
// Stats: 108 math, 4 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0
Set CUBE Texture "_ShadowMapTexture" to slot 1
Set 2D Texture "_LightTextureB0" to slot 2
...
-- Fragment shader for "d3d11":
// Stats: 114 math, 4 textures, 4 branches
Set 2D Texture "_MainTex" to slot 0
Set CUBE Texture "_ShadowMapTexture" to slot 1
Set 2D Texture "_LightTextureB0" to slot 2
Set CUBE Texture "_LightTexture0" to slot 3
...
// Approximately 0 instruction slots used
 ...
 //        d3d11: 41 avg math (41..42), 5 texture, 2 branch
 Pass {
  Name "DEFERRED"
...
SubShader { 
 ...
 // Stats for Vertex shader:
 //         d3d9: 69 avg math (45..92)
 //        d3d11: 48 avg math (32..63)
 // Stats for Fragment shader:
 //         d3d9: 106 avg math (46..166), 5 avg texture (4..7), 7 avg branch (0..14)
 //        d3d11: 113 avg math (52..175), 5 avg texture (4..7), 5 avg branch (2..8)
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="FORWARDBASE" "SHADOWSUPPORT"="true" "RenderType"="Opaque" "PerformanceChecks"="False" }
  ZWrite [_ZWrite]
...
-- Fragment shader for "d3d11":
// Stats: 52 math, 4 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0
Set 2D Texture "_OcclusionMap" to slot 1
...
// No shader variant for this keyword set. The closest match will be used instead.
 ...
 // Stats for Fragment shader:
 //         d3d9: 47 avg math (26..93), 3 avg texture (2..5)
 //        d3d11: 49 avg math (33..98), 4 avg texture (3..5), 1 avg branch (0..2)
 Pass {
  Name "FORWARD_DELTA"
  Tags { "LIGHTMODE"="FORWARDADD" "SHADOWSUPPORT"="true" "RenderType"="Opaque" "PerformanceChecks"="False" }
  ZWrite Off
