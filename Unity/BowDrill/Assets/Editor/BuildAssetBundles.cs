...
public class BuildAssetBundles : MonoBehaviour
{
    ...
    public static void ExportResource()
    {
        ...
        foreach (string eachAssetBundleName in assetBundleNames)
        {
            ...
            BuildPipeline.BuildAssetBundles(TARGET_DIRECTORY, new AssetBundleBuild[] { build }, BuildAssetBundleOptions.ForceRebuildAssetBundle, BuildTarget.StandaloneWindows64);
        }
    }
}
